                                ...
                                <div class="question">
                                  ...
                                  <div class="question">
                                    ...
                                    <form>
                                      ...
                                      <div>
                                        <button type="submit" onclick="window.location.href='amenities.jsp'" class="butt">Next<span class="glyphicon glyphicon-chevron-right"></span></button>
                                      </div>
